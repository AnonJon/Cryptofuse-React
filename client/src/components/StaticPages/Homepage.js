...
import CarouselPics from "./Carousal";
  ...
  return (
    <main data-aos="fade" className="main-homePage">
      ...
      <div className="home-stats">
        <div id="home-stat-1" data-aos="fade" data-aos-duration="1500">
          <h1>53%</h1>
          <p>Cryptofuse performance gain even in a down market. *</p>
        </div>
        <div id="home-stat-2" data-aos="fade" data-aos-duration="1500">
          <h1>1.3M+</h1>
          <p>In our diversified portfolio</p>
        </div>
        <div id="home-stat-3" data-aos="fade" data-aos-duration="1500">
          <h1>5K+</h1>
      ...
      <div className="home-why-cryptofuse">
        ...
        <div className="explain-icons-container">
          <div className="explain-icons">
            <div className="icon" data-aos="fade" data-aos-duration="1500">
              <img
                className="#"
